...
from control import tcControl   # bring in your light control
...
def main():
    ...
    # --- Initialize camera at full sensor resolution ---
    cam = Picamera2()
    full_res = (4056, 3040)   # HQ Camera full resolution
    config = cam.create_still_configuration(main={"size": full_res})
